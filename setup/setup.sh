...
echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
echo "Copy the rules files from the mindandiron setup folder"
echo "sudo cp 49-teensy.rules /etc/udev/rules.d/"
echo "sudo cp 99-kratos-devices.rules /etc/udev/rules.d/"
echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
